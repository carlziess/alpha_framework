...
class Date
{
	 ...
	 * @return string
	 */
	static public function format($format = null, $dateTime = null) {
	 ...
	 */
	static public function datePart($interval, $dateTime = null) {
	 ...
	 */
	static public function dateAdd($interval, $value, $dateTime, $format = null) {
	 ...
	 */
	static public function getRealDaysInMonthsOfYear($year) {
	 ...
	 * @return string
	 */
	static public function getChinaDate($time = null) {
	 ...
	 * @return string
	 */
	static public function getChinaWeek($week = null) {
	 ...
	 * @return string
	 */
	static public function getPeriodOfTime($hour = null) {
	 ...
	 * @return string
	 */
	static public function getUTCDate($dateTime = null) {
