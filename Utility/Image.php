...
class Image
{
	 ...
	 */
	static public function makeThumb($srcFile, $dstFile, $dstW, $dstH, $isProportion = FALSE) {
	 ...
	 * @return boolean
	 */
	static public function makeWatermark($source, $waterPos = 0, $waterImg = '', $waterText = '', $attribute = '', $waterPct = 50, $waterQuality = 75, $dstsrc = null) {
	 ...
	 * @return array|boolean
	 */
	static public function getImgInfo($srcFile) {
