...
class Validator
{
	 ...
	 */
	static public function isTelPhone($phone) {
	 ...
	 */
	static public function isTelNumber($number) {
	 ...
	 * @return boolean 如果验证失败返回false,验证成功返回true
	 */
	static public function isCellPhone($number){
		return 0 < preg_match('/^1([0-9]{9})/',$number);
	}
	/**
	 * 验证是否是QQ号码
	 ...
	 */
	static public function hasEmail($string, &$matches = array(), $ifAll = false) {
	 ...
	 * @return boolean 如果匹配成功返回true，否则返回false
	 */
	static public function hasIdCard($string, &$matches = array(), $ifAll = false) {
	 ...
	 */
	static public function isIdCard($string) {
	 ...
	 * @return boolean 如果匹配成功返回true，否则返回false
	 */
	static public function hasUrl($string, &$matches = array(), $ifAll = false) {
	 ...
	 * @return boolean 如果匹配成功返回true，否则返回false
	 */
	static public function hasChinese($string, &$matches = array(), $ifAll = false) {
	 ...
	 */
	static public function isChinese($string) {
	 ...
	 * @return boolean 如果匹配成功返回true，否则返回false
	 */
	static public function hasHtml($string, &$matches = array(), $ifAll = false) {
	 ...
	 * @return boolean 如果匹配成功返回true，否则返回false
	 */
	static public function hasIpv4($string, &$matches = array(), $ifAll = false) {
	 ...
	 */
	static public function isIpv4($string) {
	 ...
	 * @return boolean 如果匹配成功返回true，否则返回false
	 */
	static public function hasIpv6($string, &$matches = array(), $ifAll = false) {
	 ...
	 */
	static public function isIpv6($string) {
	 ...
	 * @return boolean 如果匹配成功返回true，否则返回false
	 */
	static public function hasScript($string, &$matches = array(), $ifAll = false) {
	 ...
	 */
	static public function isScript($string) {
	 ...
	 */
	static public function isNonNegative($number) {
	 ...
	 */
	static public function isPositive($number) {
		return is_numeric($number) && 0 < $number;
	}
	 ...
	 */
	static public function isNegative($number) {
		return is_numeric($number) && 0 > $number;
	}
	 ...
	 */
	static public function isLegalLength($string, $length, $charset = 'utf8') {
		return String::strlen($string, $charset) > (int) $length;
	}
     ...
     * @return boolean 如果符合规则，则返回true,否则返回false
     */
    static public function isDate($date, $format = 'Y-m-d H:i:s')
    {
